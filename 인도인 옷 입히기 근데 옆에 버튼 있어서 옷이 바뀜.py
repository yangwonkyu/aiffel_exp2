...
shirtFolderPath = "Resources-1/Resources/Shirts"
listShirts = os.listdir(shirtFolderPath)
print(listShirts)
fixedRatio = 262/190 # widthOfShirt/widthOfPoint11to12
shirtRatiowidthHeight = 581/440
imageNumber = 0
imgButtonRight = cv2.imread("Resources-1/Resources/button.png",cv2.IMREAD_UNCHANGED)
...
while True:
    ...
    #img = cv2.flip(img,1)
    lmList, bboxInfo = detector.findPosition(img, bboxWithHands=False, draw = False) #랜드마크, 바운딩박스
    if lmList:
