...
while True:
    ...
    if time.time()-timeStart < totalTime:
        ...
        if hands:
            ...
            x1, y1 = lmList[8][:2]
            x2, y2 = lmList[17][:2]  #여기서 에러가 too many values to unpack 이렇게 뜨는데 뒤에 [:2]를 붙여줘서 해결했다.
        ...
        cvzone.putTextRect(img, 'Game Over',(400,400), scale=3, offset=20, thickness=7)
        cvzone.putTextRect(img, f'Your Score:{score}',(450,500), scale=3, offset=20)
        cvzone.putTextRect(img, 'Press R to restart',(460,575), scale=3, offset=10)
